...
import heroBg from './assets/background.jpg'; // Import the background image

function App() {
  return (
    <section 
      style={{ backgroundImage: `url(${heroBg})` }} // Apply the background image
      className="bg-cover bg-center bg-no-repeat w-full h-screen font-Barlow"
    >
      <Nav />
      <div className="md:container px-2 pt-5 md:text-left text-center h-[100vh] flex flex-col justify-center">
        <h1 className="text-2xl text-white mt-10">
          <span className="text-[#ffffff70] font-bold mr-2">01</span> PICK YOUR DESTINATION
        </h1>
